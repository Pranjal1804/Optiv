...
def extract_docx_text(file_path):
    ...
    except Exception as e: print(f"DOCX extraction error: {e}")
    return clean_text(text)
...
def extract_csv_text(file_path):
    ...
    except Exception as e: print(f"CSV extraction error: {e}")
    return clean_text(text)
...
def extract_image_text(file_path):
    ...
    except Exception as e: print(f"Image OCR error: {e}")
    return clean_text(text)
    ...
    try:
        ...
        try:
            ...
            if dict_match:
                ...
                raise ValueError(f"Agent did not return a structured dictionary result: {response}")
